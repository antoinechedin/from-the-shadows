...
public class SaveManager : Singleton<SaveManager>
{
    ...
    public void CreateSaveFile(int save, int nbPlayer)
    {
        ...
        lvlChap0.Add(new Level(false, new bool[] { }, new bool[] { }, true)); //7   - La salle aux escaliers - 3 Collectibles
        ...
        lvlChap0.Add(new Level(false, new bool[] { false }, new bool[] { }, true)); //13   - Nom inconnu - 3 Collectibles
        ...
        lvlChap0.Add(new Level(false, new bool[] { }, new bool[] { false }, true)); //19    - Nom inconnu - 4 Collectibles
        ...
        lvlChap0.Add(new Level(false, new bool[] { }, new bool[] { }, true)); //26  - Nom inconnu - 7 Collectibles
        ...
        lvlChap0.Add(new Level(false, new bool[] { }, new bool[] { }, true)); //36 - Le théâtre - 0 Collectibles
        ...
        lvlChap0.Add(new Level(false, new bool[] { }, new bool[] { }, true)); //42 - L'affrontement - 0 Collectibles
